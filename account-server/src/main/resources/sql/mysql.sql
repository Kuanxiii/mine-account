CREATE TABLE economic_attributes (
    ...
    CONSTRAINT uk_attribute_user UNIQUE (user_id, attribute_name),
...
CREATE TABLE bills (
    ...
    economic_attribute_id INT COMMENT '经济属性表economic_attribute_id',
    remark VARCHAR(255) COMMENT '备注',
    insert_time DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '插入时间',
    update_time DATETIME ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE bill_attribute_relation (
    ...
    INDEX idx_purpose_attribute_id (purpose_attribute_id)
