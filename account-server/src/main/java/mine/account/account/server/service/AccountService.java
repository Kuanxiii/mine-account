...
import mine.account.account.server.mapper.BillAttributeRelationMapper;
import mine.account.account.server.mapper.BillsMapper;
...
import mine.account.account.server.po.BillAttributeRelation;
import mine.account.account.server.po.Bills;
import mine.account.account.server.po.PurposeAttributes;
import mine.account.account.server.po.example.BillAttributeRelationExample;
